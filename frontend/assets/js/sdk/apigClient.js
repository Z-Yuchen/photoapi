...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://t4187jnd4m.execute-api.us-east-1.amazonaws.com/photo';
    ...
    apigClient.uploadItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['upload', 'item', 'Content-Type'], ['body']);
        
        var uploadItemPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/{upload}/{item}').expand(apiGateway.core.utils.parseParametersToObject(params, ['upload', 'item', ])),
